...
<body>
    ...
    <hr>
<?php
/* Criando uma instância de uma classe genérica chamada stdClass (Stander Class) */
$usuario = new stdClass(); // instância ou objeto
 
// Adicionando propriedades/atributos ao objeto
$usuario->nome = "Loud Tinowns";
$usuario->idade = 25;
$usuario->email = "loudtinowns$gmail.com";
$usuario->telefones = ["11-4002-8922", "11-99397-7998"];
...
$aluno = ["nome" => "Loud", "sobrenome" => "Tinowns"];
